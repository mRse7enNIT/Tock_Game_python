...
def draw(c):
    ...
    # draw ball
    c.draw_circle(ball_pos, BALL_RADIUS, 1, "White", "Blue")
    
    # update paddles' vertical positions, keeping on the screen
    # sorry for the long lines, can't figure out how to wrap ifs
    #      without breaking functionality in CodeSkulptor
